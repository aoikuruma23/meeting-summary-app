    ...
    <div className="privacy-container">
      ...
      <div className="privacy-content">
        ...
        <div className="privacy-section">
          ...
          <p>当社は、個人情報の安全性を確保するために、以下の対策を実施しています：</p>
          <ul>
            <li>通信はHTTPSで暗号化しています</li>
            <li>お客様が入力した音声・テキストは、AIの学習には利用されません（OpenAI APIの既定設定に加え、会話ログの保存をオフに設定し、OpenAIとデータ処理契約（DPA）を締結しています）</li>
            <li>文字起こし・要約の処理完了後、サーバ上の録音音声をすみやかに自動削除します</li>
            <li>サーバのログに会議の要約本文を残さない設計としています</li>
            <li>アクセス制御・認証システムによる保護</li>
          </ul>
        </div>
        ...
        <div className="privacy-section">
          ...
          <ul>
            ...
            <li>音声データ：文字起こし・要約の処理完了後にすみやかに自動削除</li>
